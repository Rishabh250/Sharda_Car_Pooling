...
public class Khurja_Driver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Driver").child("Monthly Cab").child("Khurja");
        ...
        lists = new ArrayList<>();
        myAdapter = new MyAdapter(Khurja_Driver.this, lists);
