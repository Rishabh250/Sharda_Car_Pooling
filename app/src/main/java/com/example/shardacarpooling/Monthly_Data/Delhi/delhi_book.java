...
public class delhi_book extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delhi_book);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(PASSid.length() != 10 ){
                    Toast.makeText(delhi_book.this, "Invalid System ID", Toast.LENGTH_SHORT).show();
                    return;
                }

                if(number.length()!=10){
                    Toast.makeText(delhi_book.this, "Invalid Mobile Number", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(!PASSid.equals(dr_sys)){
                    ...
                    databaseReference.child("Delhi").child(drID).child("Passengers").child(PASSid).child("Passenger_Name").setValue(name);
                    databaseReference.child("Delhi").child(drID).child("Passengers").child(PASSid).child("Passenger_ID").setValue(PASSid);
                    databaseReference.child("Delhi").child(drID).child("Passengers").child(PASSid).child("Passenger_Number").setValue(number);

                    Toast.makeText(delhi_book.this, "Seat Booked", Toast.LENGTH_SHORT).show();

                    startActivity(new Intent(delhi_book.this, Seat_Booked_Successfully.class));
                }

                else{
                    Toast.makeText(delhi_book.this, "Driver and Passenger ID cannot be Same", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
        });
