...
public class kh_book extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kh_book);
        ...
        sysID = findViewById(R.id.kh_sysID3);
        name = findViewById(R.id.kh_name2);
        seats = findViewById(R.id.kh_total_seats);
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!PASSid.equals(dr_sys)){
                    ...
                    databaseReference.child("Khurja").child(drID).child("Passengers").child(PASSid).child("Passenger_Name").setValue(name);
                    databaseReference.child("Khurja").child(drID).child("Passengers").child(PASSid).child("Passenger_ID").setValue(PASSid);
                    databaseReference.child("Khurja").child(drID).child("Passengers").child(PASSid).child("Passenger_Number").setValue(number);

                    Toast.makeText(kh_book.this, "Seat Booked", Toast.LENGTH_SHORT).show();

                    startActivity(new Intent(kh_book.this, Seat_Booked_Successfully.class));
                }

                else{
                    Toast.makeText(kh_book.this, "Driver and Passenger ID cannot be Same", Toast.LENGTH_SHORT).show();
                    return;
                }
