...
public class Sikandrabad_Driver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Driver").child("Monthly Cab").child("Sikandrabad");
        ...
        lists = new ArrayList<>();
        myAdapter = new MyAdapter(Sikandrabad_Driver.this, lists);
