...
public class dl_details extends AppCompatActivity {
    ...
    TextView seats,sysID,name,Single_dl_car,mt,et;
    Button book;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seats = findViewById(R.id.Single_dl_seats);
        sysID = findViewById(R.id.Single_dl_sysID2);
        name = findViewById(R.id.Single_dl_name);
        book = findViewById(R.id.book);
        Single_dl_car = findViewById(R.id.Single_dl_car);
        mt = findViewById(R.id.Single_dl_MT);
        et = findViewById(R.id.Single_dl_ET);
        ...
        Single_dl_car.setText(getIntent().getStringExtra("model"));
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(dl_details.this, dl_book.class);
    ...
    public void dl_call_now(View view) {
        ...
        if(ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
            Toast.makeText(dl_details.this, "Please Grant Permission", Toast.LENGTH_SHORT).show();
            ActivityCompat.requestPermissions(dl_details.this,new String[]{Manifest.permission.CALL_PHONE},Request_Call);
        }
        else{
