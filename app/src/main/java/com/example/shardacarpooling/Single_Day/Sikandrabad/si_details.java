...
public class si_details extends AppCompatActivity {
    ...
    public void si_call_now(View view) {
        ...
        if(ContextCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED){
            Toast.makeText(si_details.this, "Please Grant Permission", Toast.LENGTH_SHORT).show();
            ActivityCompat.requestPermissions(si_details.this,new String[]{Manifest.permission.CALL_PHONE},Request_Call);
        }
        else{
