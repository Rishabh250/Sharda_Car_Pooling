...
public class Khurja_Single_driver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_khurja__driver);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Driver").child("Single Day Cab").child("Khurja");
        ...
        lists = new ArrayList<>();
        myAdapter = new MyAdapter(Khurja_Single_driver.this, lists);
