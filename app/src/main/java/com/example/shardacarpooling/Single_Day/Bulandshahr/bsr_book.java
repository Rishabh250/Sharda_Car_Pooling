    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(getdrID == value2){
                    Toast.makeText(bsr_book.this, "Driver and Passenger System ID Cannot be Same !!!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(id == dr_sys){
                    Toast.makeText(bsr_book.this, "You cannot be your own Passenger!!!!", Toast.LENGTH_SHORT).show();
                    return;
                }
