...
public class Sikandrabad_Single_driver extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sikandrabad__driver);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Driver").child("Single Day Cab").child("Sikandrabad");
        ...
        lists = new ArrayList<>();
        myAdapter = new MyAdapter(Sikandrabad_Single_driver.this, lists);
