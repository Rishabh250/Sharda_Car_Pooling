...
import com.example.shardacarpooling.Single_Day.Bulandshahr.bsr_book;
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!PASSid.equals(dr_sys)) {
                    ...
                    startActivity(new Intent(dl_book.this, Seat_Booked_Successfully.class));
                } else {
                    Toast.makeText(dl_book.this, "Driver and Passenger ID cannot be Same", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
        });
