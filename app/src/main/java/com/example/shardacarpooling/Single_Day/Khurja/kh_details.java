...
public class kh_details extends AppCompatActivity {

    TextView seats,sysID,name,Single_s_kh_car,mt,et;
    Button book;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kh_details);

        seats = findViewById(R.id.Single_s_kh_seats);
        sysID = findViewById(R.id.Single_s_kh_sysID2);
        name = findViewById(R.id.Single_s_kh_name);
        ...
        Single_s_kh_car.setText(getIntent().getStringExtra("model"));
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(kh_details.this, kh_book.class);
