    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(id == dr_sys){
                    Toast.makeText(gh_book.this, "You cannot be your own Passenger!!!!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                databaseReference.child("Ghaziabad").child(drID).child("Passengers").child(id).child("Passenger_Name").setValue(name);
                databaseReference.child("Ghaziabad").child(drID).child("Passengers").child(id).child("Passenger_ID").setValue(id);
                databaseReference.child("Ghaziabad").child(drID).child("Passengers").child(id).child("Passenger_Number").setValue(number);
